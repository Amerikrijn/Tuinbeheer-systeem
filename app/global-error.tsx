          ...
          <div className="max-w-2xl w-full">
            <div className="bg-card rounded-lg shadow-xl border border-destructive/20 p-8">
              <div className="text-center mb-6">
                <TreePine className="w-16 h-16 text-red-600 dark:text-red-400 mx-auto mb-4" />
              ...
              <div className="bg-red-50 dark:bg-red-950 border border-red-200 rounded-lg p-4 mb-6">
                <h3 className="font-semibold text-red-800 mb-2">Foutdetails:</h3>
                <p className="text-sm text-red-700 dark:text-red-300 font-mono bg-red-100 dark:bg-red-900 p-2 rounded">
                ...
                {process.env.NODE_ENV === 'development' && error.stack && (
                  <details className="mt-2">
                    ...
                    <pre className="text-xs text-red-600 dark:text-red-400 mt-2 bg-red-100 dark:bg-red-900 p-2 rounded overflow-auto max-h-32">
                      {error.stack}
                    </pre>
                  </details>
                )}
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  onClick={reset}
                  className="flex-1 bg-green-600 dark:bg-green-700 text-white dark:text-black px-4 py-2 rounded-lg hover:bg-green-700 transition-colors flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="flex-1 bg-blue-600 dark:bg-blue-700 text-white dark:text-black px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
                >
                  <RefreshCw className="w-4 h-4" />
                  Pagina Vernieuwen
                </button>
                <button
                  ...
                  className="flex-1 bg-gray-600 dark:bg-gray-300 text-white dark:text-black px-4 py-2 rounded-lg hover:bg-gray-70 dark:hover:bg-gray-700 dark:bg-gray-200 transition-colors flex items-center justify-center gap-2"
                >
