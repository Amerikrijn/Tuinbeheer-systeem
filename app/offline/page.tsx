      ...
      <div className="max-w-md w-full">
            ...
            {!isOnline && (
              <>
                ...
                <div className="space-y-3">
                  <h4 className="text-sm font-medium text-gray-700">Wat kun je nog wel doen:</h4>
        ...
        <div className="mt-6 text-center">
          <details className="text-xs text-gray-500">
            ...
            <div className="mt-2 space-y-1 text-left bg-white rounded-lg p-3 shadow-sm">
              ...
              <div className="flex justify-between">
                <span>Cache:</span>
                <span className="text-blue-600">Gecacht</span>
              </div>
              <div className="flex justify-between">
