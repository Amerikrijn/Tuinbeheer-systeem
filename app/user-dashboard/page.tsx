...
function UserDashboardContent() {
  ...
  const getEntryTypeColor = (type: LogbookEntry['entry_type']) => {
    switch (type) {
      case 'planting': return 'bg-green-100 text-green-800 dark:bg-green-950/30 dark:text-green-200'
      case 'maintenance': return 'bg-blue-100 text-blue-800 dark:bg-blue-950/30 dark:text-blue-200'
      case 'harvest': return 'bg-orange-100 text-orange-800 dark:bg-orange-950/30 dark:text-orange-200'
      case 'observation': return 'bg-purple-100 text-purple-800 dark:bg-purple-950/30 dark:text-purple-200'
      case 'problem': return 'bg-red-100 text-red-800 dark:bg-red-950/30 dark:text-red-200'
