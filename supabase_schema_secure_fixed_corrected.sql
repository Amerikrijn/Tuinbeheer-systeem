-- SECURE SUPABASE SQL SCHEMA - BACKWARD COMPATIBLE (CORRECTED)
-- Versie: 2.2 - BEHOUDT BESTAANDE TABELLEN + JUISTE KOLOM NAMEN
-- Datum: 2024
...
-- Plants table (CORRECTED: plant_bed_id ipv bed_id)
...
-- ===========================================
-- PLANTS POLICIES (CORRECTED: plant_bed_id)
-- ===========================================
...
/*
FIXED ISSUES:
✅ Corrected bed_id → plant_bed_id in plants table
✅ Updated all policies to use correct column names
✅ Fixed indexes to match actual schema
...
- CORRECTED: Matches existing column names
*/