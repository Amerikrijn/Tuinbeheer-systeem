-- =====================================================================
-- SUPABASE COMPLETE DATABASE FIX - ONE SCRIPT SOLUTION
-- =====================================================================
-- This script does EVERYTHING: cleanup + complete setup
-- Copy this ENTIRE script and paste it into Supabase SQL Editor
-- Click RUN once and your database will be completely fixed
-- =====================================================================
...
DROP INDEX IF EXISTS idx_plants_planting_date CASCADE;
DROP INDEX IF EXISTS idx_gardens_active CASCADE;

-- =====================================================================
-- PART 2: COMPLETE SETUP
-- =====================================================================
...
SELECT 
    'SUCCESS: Database completely fixed and ready!' as status,
    'Tables created: ' || (
...
SELECT 'Gardens:' as table_name, id, name, location, canvas_width, canvas_height FROM gardens;
SELECT 'Plant beds:' as table_name, id, name, position_x, position_y, visual_width, visual_height, color_code FROM plant_beds;
SELECT 'Plants:' as table_name, name, scientific_name, variety, status, plant_bed_id FROM plants;

-- Final confirmation
SELECT 'DATABASE COMPLETELY FIXED! Your gardens table exists and everything is working!' as final_status;