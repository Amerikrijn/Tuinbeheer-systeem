  ...
  switch (urgency) {
    ...
    case 'completed':
      return {
        container: 'border-border bg-card',
        title: 'text-foreground',
        badge: 'bg-green-100 text-green-800 border-green-300 dark:bg-green-950/30 dark:text-green-200 dark:border-green-800',
        badgeText: '✅ Voltooid'
      }
    default:
      return {
        container: 'border-border bg-card',
        title: 'text-foreground',
        badge: 'bg-blue-100 text-blue-800 border-blue-300 dark:bg-blue-950/30 dark:text-blue-200 dark:border-blue-800',
        badgeText: '📋 Actief'
      }
  }
}